...
class RuleGroupTest {
    ...
    void testAndCombinatorAllTrue() {
        RuleGroup<String> group = RuleGroup.<String>builder()
    ...
    void testNestedGroupsAnd() {
        RuleGroup<String> inner = RuleGroup.<String>builder()
                .combinator(Combinator.AND)
                .conditions(List.of(TestUtils.alwaysTrueRule(), TestUtils.alwaysTrueRule()))
                .build();
        RuleGroup<String> outer = RuleGroup.<String>builder()
                .combinator(Combinator.AND)
    ...
    void testDeeplyNestedGroups() {
        RuleGroup<String> level3 = RuleGroup.<String>builder()
                .combinator(Combinator.AND)
                .conditions(List.of(TestUtils.alwaysTrueRule()))
                .build();
        RuleGroup<String> level2 = RuleGroup.<String>builder()
                .combinator(Combinator.AND)
                .conditions(List.of(level3))
                .build();
        RuleGroup<String> level1 = RuleGroup.<String>builder()
                .combinator(Combinator.AND)
                .conditions(List.of(level2))
                .build();
