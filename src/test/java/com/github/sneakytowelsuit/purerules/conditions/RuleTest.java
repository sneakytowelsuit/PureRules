...
class RuleTest {
   private static final Long THREAD_ID = 1L;
    ...
    void testEvaluateReturnsTrue() {
        Rule<String, Integer> rule = Rule.<String, Integer>builder()
    ...
    void testEvaluateWithNullOperatorThrows() {
        Rule<String, Integer> rule = Rule.<String, Integer>builder()
                ...
                .value(5)
                .build();
        assertThrows(AssertionError.class, () -> rule.evaluate("hello", Collections.emptyList(), THREAD_ID));
    }
    ...
    void testEvaluateWithNullFieldValueFunctionThrows() {
        Field<String, Integer> field = new Field<String, Integer>() {
            @Override
    ...
    void testRuleIdIsUnique() {
        Rule<String, Integer> rule1 = Rule.<String, Integer>builder()
                .field(new TestUtils.DummyField())
                .operator(new TestUtils.AlwaysTrueOperator())
                .value(5)
                .build();
        Rule<String, Integer> rule2 = Rule.<String, Integer>builder()
                .field(new TestUtils.DummyField())
                .operator(new TestUtils.AlwaysTrueOperator())
                .value(5)
                .build();
