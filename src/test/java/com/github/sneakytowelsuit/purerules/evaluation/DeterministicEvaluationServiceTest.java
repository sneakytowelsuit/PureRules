...
class DeterministicEvaluationServiceTest {
    ...
    void testEvaluateWithSingleRule() {
        Rule<TestHelpers.Something, String> rule = Rule.<TestHelpers.Something, String>builder()
                ...
                .weight(1)
                .build();
        DeterministicEvaluationService<TestHelpers.Something, Integer> service = new DeterministicEvaluationService<>(List.of(rule));
    ...
    void testEvaluateWithRuleGroupAllTrue() {
        ...
        RuleGroup<TestHelpers.Something> group = RuleGroup.<TestHelpers.Something>builder()
                ...
                .build();
        DeterministicEvaluationService<TestHelpers.Something, Integer> service = new DeterministicEvaluationService<>(List.of(group));
        TestHelpers.Something alice = new TestHelpers.Something(1, "Alice");
    ...
    void testEvaluateWithMixedRuleAndGroup() {
        ...
        RuleGroup<TestHelpers.Something> group = RuleGroup.<TestHelpers.Something>builder()
                ...
                .build();
        DeterministicEvaluationService<TestHelpers.Something, Integer> service = new DeterministicEvaluationService<>(List.of(rule, group));
        TestHelpers.Something alice = new TestHelpers.Something(1, "Alice");
        TestHelpers.Something bob = new TestHelpers.Something(2, "Bob");
        Map<String, Boolean> resultAlice = service.evaluate(alice, dummyContextService);
        Map<String, Boolean> resultBob = service.evaluate(bob, dummyContextService);
    ...
    void testEvaluateWithNestedGroups() {
        Rule<TestHelpers.Something, String> ruleA = Rule.<TestHelpers.Something, String>builder()
                .field(new TestHelpers.SomethingNameField())
                .operator(new TestHelpers.StringEqualsCaseInsensitiveOperator())
                .value("Alice")
                .weight(1)
                .build();
        Rule<TestHelpers.Something, String> ruleB = Rule.<TestHelpers.Something, String>builder()
                .field(new TestHelpers.SomethingNameField())
                .operator(new TestHelpers.StringEqualsCaseInsensitiveOperator())
                .value("Bob")
                .weight(1)
                .build();
        RuleGroup<TestHelpers.Something> innerGroup = RuleGroup.<TestHelpers.Something>builder()
                .id("inner")
                .combinator(Combinator.OR)
                .conditions(List.of(ruleA, ruleB))
                .build();
        RuleGroup<TestHelpers.Something> outerGroup = RuleGroup.<TestHelpers.Something>builder()
                .id("outer")
                .combinator(Combinator.AND)
                .conditions(List.of(innerGroup))
                .build();
        DeterministicEvaluationService<TestHelpers.Something, Integer> service = new DeterministicEvaluationService<>(List.of(outerGroup));
        TestHelpers.Something alice = new TestHelpers.Something(1, "Alice");
        TestHelpers.Something bob = new TestHelpers.Something(2, "Bob");
        TestHelpers.Something charlie = new TestHelpers.Something(3, "Charlie");
    ...
    void testEvaluateWithEmptyRuleGroup() {
        RuleGroup<TestHelpers.Something> emptyGroup = RuleGroup.<TestHelpers.Something>builder()
                .id("empty")
                .combinator(Combinator.AND)
                .build();
        DeterministicEvaluationService<TestHelpers.Something, Integer> service = new DeterministicEvaluationService<>(List.of(emptyGroup));
        TestHelpers.Something alice = new TestHelpers.Something(1, "Alice");
